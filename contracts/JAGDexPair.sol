...
contract JAGDexPair is Context, JAGDexERC20 {
    ...
    modifier lock() {
        require(unlocked == 1, "JAGDex: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function _mintFee(
        ...
        address feeTo = IJAGDexFactory(factory).feeTo();
    ...
    function mint(address to) external lock returns (uint liquidity) {
        ...
        require(liquidity > 0, "JAGDex: INSUFFICIENT_LIQUIDITY_MINTED");
        _mint(to, liquidity);
    ...
    function burn(
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "JAGDex: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "JAGDex: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "JAGDex: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint balance1;
        {
            ...
            require(to != _token0 && to != _token1, "JAGDex: INVALID_TO");
        ...
        require(
            ...
            "JAGDex: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
